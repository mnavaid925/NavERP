...
- **[ ] C1: Concurrency Race Condition in Invoice Creation (`pbr_generate_invoice`)**
...
- **[ ] C2: Broken Pagination & Search Query Bypass in All 4 List Templates**
  - **Location**:
...
- **[ ] C3: Missing / Broken Record Number and False "INV-DRAFT" Fallback in A/R Aging Board**
...
- **[ ] C4: N+1 Queries, Missing Relation, and Blank Invoice Total in Payment Records Views**
...
- **[ ] C5: O(N) Query Explosions in `financial_pnl`**
...
- **[ ] I1: Generated `InvoiceLine` Items Omit Tax Rate in `pbr_generate_invoice`**
...
- **[ ] I2: Navigation Structure Divergence in `apps/core/navigation.py` (`LIVE_LINKS["7.15"]`)**
...
- **[ ] I3: Incomplete Form Re-exports in `apps/projects/forms/__init__.py`**
...
- **[ ] I4: Missing Status / Stage Guard on Collection Escalation (`ppr_escalate`)**
...
- **[ ] I5: EVM Variance Board Evaluates 4-5 Queries per Control Account**
...
- **[ ] I6: A/R Aging and Cash Flow Forecast Loop Calling Uncached `balance_due()` and Full-Table Outflows**
...
- **[ ] I7: Stage Badge Choices Mismatched with Model `STAGE_CHOICES` in `aging.html`**
...
- **[ ] I8: Non-Existent Theme Utility Classes in Financial Boards Templates**
