...
3.19 Performance Review, 3.20 Continuous Feedback, 3.21 Performance Improvement, 3.22 Training Management.** Reuses the
...
import, USD-or-first, blank if none) — creates NO new person/vendor/currency rows. ASCII-only stdout. Runs **LAST**,
after `_seed_improvement`.
...
upgrade, evergreen auto-reopen), (the Performance-Management cluster — 3.18 Goal Setting, 3.19 Performance Review, 3.20 Continuous Feedback, 3.21 Performance Improvement — is now **built**; 3.22 Training Management is now **built**, with 3.23 Learning Management (LMS) + 3.24 Training Administration its deferred siblings),
