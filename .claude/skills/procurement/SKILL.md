...
**As-built: 6.1–6.19 — the module is COMPLETE (all 19 sub-modules).** 6.4 Vendor Management lives in
`VendorManagement/` (models/forms/views/urls) + `templates/procurement/vendormanagement/`.
Per-sub-module as-built notes appear in the sections below, the last being `As-built now: 6.1–6.19`.
