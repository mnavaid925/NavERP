...
class Command(BaseCommand):
    ...
    def _financial_billing(self, tenant, now):
        ...
        rtc1 = ProjectRateCard.objects.create(
            ...
            effective_to=today + timedelta(days=275),
            is_active=True,
        ...
        rtc2 = ProjectRateCard.objects.create(
            ...
            activity_code="ARCH-01",
            hourly_rate=Decimal("220.00"),
            expense_markup_pct=Decimal("15.00"),
            currency=currency,
            effective_from=today - timedelta(days=90),
            effective_to=today + timedelta(days=275),
            is_active=True,
        ...
        rtc3 = ProjectRateCard.objects.create(
            ...
            activity_code="DEV-01",
            hourly_rate=Decimal("145.00"),
            expense_markup_pct=Decimal("5.00"),
            currency=currency,
            effective_from=today - timedelta(days=60),
            effective_to=today + timedelta(days=300),
            is_active=True,
        ...
        rtc4 = ProjectRateCard.objects.create(
            ...
            expense_markup_pct=Decimal("0.00"),
            currency=currency,
        ...
        pbr1 = ProjectBillingRun.objects.create(
            ...
            cutoff_date=today,
            total_time_hours=Decimal("160.00"),
            labor_amount=Decimal("28000.00"),
        ...
        pbr2 = ProjectBillingRun.objects.create(
            ...
            total_time_hours=Decimal("0.00"),
            fee_amount=Decimal("35000.00"),
        ...
        pbr3 = ProjectBillingRun.objects.create(
            ...
            total_time_hours=Decimal("45.00"),
            labor_amount=Decimal("6300.00"),
        ...
        prs2 = ProjectRevenueSchedule.objects.create(
            ...
            project=active_proj,
            milestone=None,
            recognition_date=today - timedelta(days=5),
            method="percent_complete",
            contract_amount=Decimal("120000.00"),
            completion_percent=Decimal("60.00"),
        ...
        prs3 = ProjectRevenueSchedule.objects.create(
            ...
            completion_percent=Decimal("33.33"),
        ...
        if inv1:
            ProjectPaymentRecord.objects.create(
                ...
                promised_amount=Decimal("28000.00"),
                promised_payment_date=today + timedelta(days=5),
                assigned_collector=manager,
                status="open",
        ...
        if inv2:
            ProjectPaymentRecord.objects.create(
                ...
                promised_amount=Decimal("15500.00"),
                promised_payment_date=today + timedelta(days=3),
                assigned_collector=manager,
                status="open",
