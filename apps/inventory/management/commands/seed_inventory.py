...
5.2 Vendor / Supplier Management, 5.3 Purchase Order (PO) Management and
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            help=("Delete ALL inventory rows (attributes, prices, files, vendor communications, "
                  "PO approval rules/dispatches, bin capacities, cross-dock orders) for ALL "
                  "tenants before seeding — not just seeder-created ones."))
